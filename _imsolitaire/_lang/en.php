...
store_version_description=A simple yet engaging Solitaire card game built with JavaScript. Enjoy the classic single-player experience right in your browser, featuring smooth gameplay and an easy-to-use interface.