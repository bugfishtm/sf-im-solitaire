...
store_version_name=Пасьянс
store_version_description=Простая, но увлекательная карточная игра Пасьянс, созданная на JavaScript. Наслаждайтесь классическим одиночным режимом прямо в вашем браузере с плавным игровым процессом и удобным интерфейсом.
